    ...
    <div className="bg-gray-900/50 rounded-lg p-4">
      ...
      <div className="text-xs space-y-1 mb-3">
        <div className="flex items-start gap-2">
          ...
          <span className="text-gray-300">{metric.thresholds.good}</span>
        </div>
        <div className="flex items-start gap-2">
          <span className="w-2 h-2 rounded bg-yellow-500 mt-1 shrink-0" />
          <span className="text-gray-300">{metric.thresholds.warning}</span>
        </div>
        <div className="flex items-start gap-2">
          <span className="w-2 h-2 rounded bg-red-500 mt-1 shrink-0" />
          <span className="text-gray-300">{metric.thresholds.danger}</span>
        </div>
      </div>
