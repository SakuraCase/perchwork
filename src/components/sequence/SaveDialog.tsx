...
export interface SaveDialogProps {
  /** ダイアログの表示状態 */
  isOpen: boolean;
  /** 既存の保存済みシーケンス（同じrootFunctionIdのもの） */
  existingSaves: SavedSequenceDiagram[];
...
export function SaveDialog({
  ...
  const handleSelectExisting = (save: SavedSequenceDiagram) => {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
      ...
      >
        ...
        <div className="px-4 py-3 border-b border-stone-700">
          <h2 className="text-sm font-semibold text-stone-100">シーケンスを保存</h2>
        </div>
