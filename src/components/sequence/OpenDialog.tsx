/**
 * OpenDialog - シーケンス開くダイアログ
 *
 * 保存済みシーケンス一覧から選択して開く、または削除する
 */
...
export interface OpenDialogProps {
  ...
  /** 選択時のコールバック */
  onSelect: (saved: SavedSequenceDiagram) => void;
  /** 削除時のコールバック */
...
export function OpenDialog({
  ...
  const [deleteTarget, setDeleteTarget] = useState<SavedSequenceDiagram | null>(null);
  ...
  const handleDeleteClick = (e: React.MouseEvent, saved: SavedSequenceDiagram) => {
    e.stopPropagation();
